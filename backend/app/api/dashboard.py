...
@router.get("/top-products-qty", response_model=dict, responses={401: {"model": ErrorResponse}})
...
@router.get("/top-products-revenue", response_model=dict, responses={401: {"model": ErrorResponse}})
...
@router.get("/sales-by-month", response_model=dict, responses={401: {"model": ErrorResponse}})
...
@router.get("/warehouse-stocks", response_model=dict, responses={401: {"model": ErrorResponse}})
