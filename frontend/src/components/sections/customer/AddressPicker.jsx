    ...
    <Dialog>
      <form>
        ...
        <DialogContent className="sm:max-w-[425px] bg-secondary border-accent-dark border-2">
          ...
          <DialogFooter>
            <div className="mr-8">
              <p className="text-xs mb-2 font-semibold text-text-dark">Address phone number</p>
              <input
                type="text"
                value={phonenum}
                ...
                className='bg-secondary text-md py-1 w-full rounded-md border border-accent-ui text-text-dark px-2'
              />
            </div>
                ...
                <DialogClose asChild>
                  <Button type="submit" 
                    className='shadow-sm hover:bg-accent-dark transition-colors duration-200 ease-in-out'
                      ...
                      onClick={()=>{
                        const formatted = phonenum.slice(0, 4) + '-' + phonenum.slice(4, 8) + '-' + phonenum.slice(8, 12);
                        onSelect(selected.address, formatted);
                      }}
                  >Save changes
                  </Button>
                </DialogClose>
