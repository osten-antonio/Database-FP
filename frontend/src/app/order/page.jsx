...
export default function Order() {
    ...
    const table = useReactTable({
        ...
        getRowId: (row, index) => `${row.order_id}-${index}`,
    ...
    return(
        <div className="p-6 w-screen xl:ml-auto xl:w-6/7 2xl:w-8/9 mt-12">
            ...
            <div className='flex flex-row flex-wrap justify-between gap-2'>
                <button className='bg-primary p-2 px-10 rounded-lg text-text-light font-semibold'>
                    Create
                </button>
                <div className='w-xl flex flex-row gap-2'>
                    <form className='w-full min-w-[250px] grow'>
                        <input type='text' className='bg-primary-light h-full w-full rounded-md text-text-light px-2' placeholder='Search'/>
                    </form>
                    <button 
                        className='flex flex-nowrap gap-2 bg-primary p-2 px-5 rounded-lg text-text-light font-semibold'
                    >
                        <ListFilter/>
                        Filter
                    </button>
